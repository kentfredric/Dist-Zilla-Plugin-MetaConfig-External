...
has '_trait_namespace' => ( Moose->VERSION >= '0.85' ? ( is => 'bare' ) : (), default => 'Net::Twitter::Role', );
...
sub new {
  ...
  if ( $class ne __PACKAGE__ ) {
    ...
    my $final_meta = _create_anon_class( $superclasses, $traits, 0, join '::', $class, $anon_class_name );
